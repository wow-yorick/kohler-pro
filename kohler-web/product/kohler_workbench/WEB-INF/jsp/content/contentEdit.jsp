			...
			<form id="updateContentForm">
				<div class="search">
					...
					<div class="row">
						...
						<div class="col-md-6"><input required="required" maxLength="8" digits="true" type="text" name="seqNo" value="${contentMetadata.seqNo }"></div>
					</div>
				</div>
			</form>
			<div class="search">
	...
	jQuery.validator.addMethod("isFieldValueUnique", function(value, element) { 
	    ...
	    if(element.value!=''){
		    $.ajax({
				...
				data:"fieldname="+element.name+"&fieldvalue="+element.value+"&lang="+element.getAttribute('isFieldValueUnique')+"&metadataId=${contentMetadata.contentMetadataId }",
	            async:false,
	            type:'POST',
	            //dataType:"json",
