...
<div class="container admin_roles">
    ...
    <div class="main">
    	<div class="search">
            ...
            <div class="row">
            	<div class="title">Comapny Info</div>
            </div>
            <div class="clear"></div>
            <div class="row">
            	<div class="col-md-2 linesmall">Company Telephone</div>
				<div class="col-md-4">${AccountView.COMPANY_TELEPHONE}</div>
            </div>
            <div class="row">
            	<div class="col-md-2">Province</div>
            	<div class="col-md-4">上海市</div>
                <div class="col-md-2">City</div>
            	<div class="col-md-4">上海市</div>
            </div>
        	<div class="row">
            	<div class="col-md-2">District</div>
            	<div class="col-md-4">浦东新区</div>
            </div>
            <div class="row">
