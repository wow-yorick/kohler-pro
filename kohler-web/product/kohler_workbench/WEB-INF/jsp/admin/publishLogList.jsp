					...
					<div class="query row">
						...
						<div class="opera_con col-md-4">
							...
							<a class="btn " href="javascript:void(0);" onclick="unlockPublish()" >Unlock</a> <a
								...
								class="btn Rollback" href="#">Rollback</a>
						</div>
					</div>
				</div>
				<!-- 操作及筛选区域condition结束-->
									...
									<c:forEach items="${pager.datas}" var="publishLog">
										<tr>
											<td>
												...
												</div> <a href="javascript:void(0);" class="ope_icon detail"></a>
											</td>
...
//							$(this).attr("checked","checked");
	...
	function executeManualPublish() {
		var checkboxs = $("input[name='publishLogId']:checked");
		...
		var publishLogId = checkboxs.val();
		$.layer({
			type : 2,
			...
			iframe : {
				src : 'view.action?publishLogId=' + publishLogId
			}
		});
	}
