    ...
    <form id="templateFrom" action="createSave.action" enctype="multipart/form-data" method="post">
    	<div class="search">
        	...
        	<div class="row">
            	...
            	<div class="col-md-4"><input type="text" name="templateName" value=""/></div>
            ...
            <div class="row">
                ...
                <div class="col-md-10"><input type="text" value="" name="physicalName"/></div> 
            </div> 
            <div class="row">
            	<div class="col-md-2 line">Template File Content</div>
                <div class="col-md-10"> <textarea name="templateContent"></textarea ></div> 
            </div>     	
            <div class="row">
