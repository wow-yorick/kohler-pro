										...
										<c:forEach items="${productVideolist}" var="video">
											<c:if test="${video.lang eq language.localeId}">
												...
												<div class="row">
													...
													<div class="col-md-9">
														<input type="text" name="productVideoName" value="${video.productVideoName}" />
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-9">
														<input type="text" name="fileUrl" value="${video.fileUrl}" />
													</div>
												</div>
												<div class="row">
												...
												<div class="row large">
													...
													<div class="col-md-9">
														<textarea rows="2" name="description">${video.description}</textarea>
													</div>
												</div>
											</c:if>
										</c:forEach>
