				...
				<form id="searchForm" action="${pager.url}" method="get" >
					...
					<div class="query row">
						...
						<div class="opera_con btnr">
							...
							<a class="btn" href="javascript:void(0);" onclick="initViewPage()">Preview</a>
							</per:user>
						</div>
					</div>
					</form>
...
function initNewPage() {
	alertFirstIframe("Suite","create.action",'700px','525px');
}
/**
 * 显示编辑页
 */
function initEditPage(keyId) {
	...
	alertFirstIframe("Suite","edit.action?suiteMetadataId="+keyId,'700px','525px');
}
...
function initViewPage(keyId) {
	...
	alertFirstIframe("Suite","view.action?suiteMetadataId="+keyId,'700px','525px');
}
