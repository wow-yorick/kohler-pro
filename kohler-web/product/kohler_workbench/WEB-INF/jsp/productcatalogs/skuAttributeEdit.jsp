					...
					<div class="row">
						...
						<div class="col-md-4">
							<input type="text" name="keyName"
								value="${categorySkuAttrMetadata.keyName }" />
						</div>
					</div>
					<div class="row">
													...
													<div class="row">
														...
														<div class="col-md-9">
															<input type="text" name="categorySkuAttrName"
																value="${skuAttr.categorySkuAttrName }" />
														</div>
													</div>
													<div class="row">
					...
					<c:forEach items="${metaList}" var="skuAttrValuesMeta" varStatus="status">
						<div class="row">
							<div class="col-md-8 border">
								<input type="text" name="valuesImageUrl" value="${skuAttrValuesMeta.imageId }" id = "imageUrl${status.index+1}" />
							</div>
							<div class="col-md-4">
