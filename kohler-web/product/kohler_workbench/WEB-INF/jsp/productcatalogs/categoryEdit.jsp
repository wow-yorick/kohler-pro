										...
										<div class="row">
											...
											<div class="col-md-4">
												<input type="text" name="seoTitlePcs"
													value="${catePojo.category.seoTitlePc }" />
											</div>
											<div class="col-md-2 tn_c">H1 Tag</div>
											<div class="col-md-4">
												<input type="text" name="seoH1tagPcs"
													value="${catePojo.category.seoH1tagPc }" />
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-10">
												<input type="text" name="seoKeywordsPcs"
													value="${catePojo.category.seoKeywordsPc }" />
											</div>
										</div>
									...
									<div class="hide box">
										<div class="box">
											...
											<div class="row">
												...
												<div class="col-md-2 tn_c">Breadcrumb Name_${language.localeCode }</div>
                        					<div class="col-md-4">
