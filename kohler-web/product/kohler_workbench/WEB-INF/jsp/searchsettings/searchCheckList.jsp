...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.ztree.all-3.5.min.js"></script>
    ...
    function updateSpelling(spellingId){
    	alertFirstIframe("update","edit.action?spellingId="+spellingId+"&isEdit=0",'840px','600px');
    }
    function searchSpelling(spellingId){
    	alertFirstIframe("update","edit.action?spellingId="+spellingId+"&isEdit=1",'840px','600px');
    }
    function deleteSeplling(){
    	var jsonData = "";
		var chooses = $("input[name='searchSpellingCheckId']:checked");
		if(chooses.length == 0){
		...
		<div class="content">
			...
			<div class="content_main">
				...
				<div class="condition">
					...
					<form id="searchForm" action="searchSpellingCheckList.action" method="post">	
						<div class="query row">
							<div class="col-md-10">
							...
							<div class="opera_con col-md-2 opera_fr">
								<a class="btn" href="javascript:void(0);" onclick="searchSpellings();">Search</a>
								<a class="btn long" href="javascript:void(0);" onclick="createSpelling();">Create</a>
								...
								<tr>
										<td>
											<div class="checkbox">
												...
												<input type="checkbox" value="${l.searchSpellingCheckId}"
												    name="searchSpellingCheckId">
											</div>
											<a href="#" class="ope_icon edit" onclick="updateSpelling('${l.searchSpellingCheckId}');"></a>
											<a href="#" class="ope_icon detail" onclick="searchSpelling('${l.searchSpellingCheckId}');"></a>
										</td>
