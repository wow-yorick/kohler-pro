...
<div class="container admin_roles">
    ...
    <div class="main">
        ...
        <c:if test="${type == 2 }">
	        <div class="row">
				<div class="col-md-2 line">${title} Reason</div>
				<div class="col-md-10">
   ...
   <!-- 关闭frame-->
       <script  type="text/javascript">
			...
			<c:if test="${type == 2}">
				var ue=UeditorFileLoad.init("freezeReason");
			</c:if>
			function editsave()
			{   
				var id="${AccountView.ACCOUNT_ID}",freezeReason=ue.getContentTxt();;
				$.post("${title}Save.action", "accountId=" + id+ "&freezeReason="
