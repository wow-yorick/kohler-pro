    ...
    <form action="" id="suiteProductDetailForm">
    	...
    	<div class="search">
            ...
            <div class="row">
                ...
                <div class="col-md-4 "><input type="text" disabled="disabled" id="skuCodeName" />
                <input type="hidden" id="skuMetadataId"  name="skuMetadataId" /></div> 
                <div class="col-md-2">
	...
	$.post("unlimited/createSave.action", detailForm.serialize(), 
			function(data) {
				if(data.success) {
					...
					var skuCodeName = $("#skuCodeName").val();
					var html = '<tr>'
						    +'<td class="tn_c">'
