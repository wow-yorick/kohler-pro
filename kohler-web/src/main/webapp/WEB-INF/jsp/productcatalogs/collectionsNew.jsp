...
<div class="container queryConditions suites">
    	...
    	<div class="search">
        	...
        	<div class="row">
            	<div class="col-md-2">SeqNo</div>
  				<div class="col-md-4"><input type="text" name="seqNo"  value="" /></div>
            </div>
            </form>     	
        </div>             
				            	...
				            	<div class="box">
				            		<form id="lan">
					                    ...
					                    <div class="row">
					                        ...
					                        <div class="col-md-4"><input type="text"  name="collectionStyleName"  isUnique="${language.localeId}"  maxlength="25"  placeholder=""/></div> 
					                    </div>
				                    </form>                  
				                  </div>
				                  </c:when>
    ...
    <script>
    	function addProduct() {
    		...
    		$.post("createSave.action",$("#CollectionStyleMetadata").serialize() +"&products=" + products, function(data) {
