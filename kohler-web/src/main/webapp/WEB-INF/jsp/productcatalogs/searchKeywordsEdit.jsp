		...
		<div class="main">
			...
			<input type = "hidden" name = "categorySearchKeywordMetadataId" value = "${categorySearchKeywordMetadata.categorySearchKeywordMetadataId }" />
				<div class="search">
					...
					<div class="row">
						<div class="col-md-2 required">SeqNo</div>
						<div class="col-md-4">
							<input type="text" name="seqNo" required="required" digits="true" value = "${categorySearchKeywordMetadata.seqNo }" />
						</div>
					</div>
				</div>
			</form>
								...
								<div class="box">
									...
									<c:forEach items="${searchKeywordList }" var="searchKey">
										...
										<div class="row">
											...
											<div class="col-md-10">
												<input type="text" name="keyword" maxlength="25" value = "${searchKey.keyword }" />
											</div>
										</div>
										<div class="row">
