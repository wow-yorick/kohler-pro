        ...
        <div class="tab" id="tab">
										...
										<c:forEach items="${NewArrival}" var="newArrival">
										  <c:if test="${newArrival.lang eq language.localeId}">
						                    ...
						                    <div class="row">
						                        ...
						                        <div class="col-md-4"><input type="text"  name="newArrivalName" value="${newArrival.newArrivalName}"  isUnique="${language.localeId}"  required maxlength="25"   placeholder=""/></div> 
						                    </div>
						                    <div class="row">
							                    ...
							                    <div class="row">
							                        ...
							                        <div class="col-md-4">
							                           <select name="mobileTemplateId">
																<option></option>
																<c:forEach items="${masterData.tempList_pc}" var="templete_mobile">
																	<option value="${templete_mobile.templateId}" <c:if test="${newArrival.mobileTemplateId eq templete_mobile.templateId}">selected</c:if> >${templete_mobile.templateName}</option>
																</c:forEach>
														</select>
							                        </div> 
        	...
        	<div class="text">
	            <div class="row text_row">
		                ...
		                <input type="text"  id="heroAreaMetadataId" name="heroAreaMetadataId" value='<c:forEach items="${NewArrivalHeroArea}" var="NewArrivalHeroArea">${fn:trim(NewArrivalHeroArea.FIELD_VALUE)}</c:forEach>' /></div> 
		                <div class="col-md-1">
		                    <a class="choose tn_c" onclick="openDataTypePicker('93','mydatatype93','heroAreaMetadataId');" href="#">Choose</a>
		                    <input type='hidden' name='datatype93' id="mydatatype93"  
		                    value='
		                        <c:forEach items="${NewArrivalHeroArea}" var="NewArrivalHeroArea">
		                    		${NewArrivalHeroArea.HERO_AREA_METADATA_ID}
		                    	</c:forEach>
		                    ' />
		                </div>
		            ...
		            <div class="row text_row">
		                ...
		                <div class="col-md-9 border">
		                	<input type="text" id="bannerUnitMetadataId" name="bannerUnitMetadataId" value='<c:forEach items="${NewArrivalBanner}" var="NewArrivalBanner">${NewArrivalBanner.FIELD_VALUE}</c:forEach>'  /></div> 
		                <div class="col-md-1">
		                    ...
		                    <input type='hidden' name='datatype94' id="mydatatype94" value='
		                    	<c:forEach items="${NewArrivalBanner}" var="NewArrivalBanner">
		                    		${NewArrivalBanner.BANNER_UNIT_METADATA_ID}
		                    	</c:forEach>
		                    ' />
		                </div>
		            </div>
