            					...
            					<form id="lan${status.index}">
									<input type="hidden" name="lang" value="${language.localeId }" />
                 					<div class="row">
                      	 				...
                      	 				<div class="col-md-9">
                           					<input type="text" name="productPartName" maxlength="25" required/>
                       					</div> 
                    				</div>
                    				<div class="row">
                   					...
                   					<div class="row">
                       					...
                       					<div class="col-md-9">
                           					<input type="text" name="imageUrl" required maxlength="250"/>
                       					</div> 
                   					</div> 
                   					<div class="row">
										...
										<div class="col-md-7">
											...
											<input type="text" readonly="readonly" name="notputsql_showfileName${language.localeId }" required id="showfileName${language.localeId }" />
										</div>
										<div class='col-md-2 '>
                				...
                				<form id="lan${status.index}">
									<input type="hidden" name="lang" value="${language.localeId }" />
                        				...
                        				<div class="col-md-3 tn_l">Part Name_${language.localeCode}</div>
                       	 				<div class="col-md-9">
                            				<input type="text" maxlength="25" name="productPartName"/>
                        				</div> 
                    				</div>
                   					<div class="row">
