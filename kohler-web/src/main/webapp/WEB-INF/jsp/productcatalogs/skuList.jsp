...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
	...
	<tr class="head">
		...
		<th class="head_r"><a href="javascript:void(0);" class="sku_new"
			onclick="onlyProductAlertIframe('SKU','../sku/unlimited/newSKUPage.action?productMetadataId=${productMetadataId}&categoryMetadataId=${categoryMetadataId}','770px','550px');">Create</a>
		</th>
	</tr>
			...
			<table class="small" border="0" cellspacing="0" cellpadding="0">
				...
				<c:forEach items="${skuMaplist}" var="skulist" varStatus="status">
					...
					<td class="tn_c"><span class="edit sku_new"
						onclick="onlyProductAlertIframe('SKU','../sku/unlimited/editSKUPage.action?skuMetadataId=${skulist.skuMetadataId}&productMetadataId=${productMetadataId}&categoryMetadataId=${categoryMetadataId}','770px','550px');"></span>
