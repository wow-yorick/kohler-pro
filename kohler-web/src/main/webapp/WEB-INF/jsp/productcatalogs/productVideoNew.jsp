...
<script type="text/javascript">
	...
	function addProductVideo() {
		...
		$("#addProductVideoForm").valid();
        if ($("#errorMessage").html() != "") {
            alert($("#errorMessage").html());
            return false;
        }
		productVideos += "]";
		$.post("saveProductVideo.action", $("#addProductVideoForm").serialize() + "&productVideos=" + productVideos , 
			function(data) {
...
<body>
	<div class="container queryConditions product_layer partsImages">
		...
		<div class="main">
								...
								<div class="box" id="divlan${status.index}">
									<form id="lan${status.index}">
										...
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" maxlength="25" name="productVideoName" required/>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											...
											<div class="col-md-7">
												...
												<input type="text" readonly="readonly" required name="notputsql_showfileName${language.localeId }" id="showfileName${language.localeId }" />
											</div>
											<div class='col-md-2 '>
									...
									<form id="lan${status.index}">
										...
										<div class="row">
											<div class="col-md-3 tn_l">Video
												Name_${language.localeCode}</div>
											<div class="col-md-9">
												<input type="text" maxlength="25" name="productVideoName" />
											</div>
										</div>
										<div class="row">
			...
			<div class="btns">
				<a href="javascript:void(0);" class="confirm" onclick="addProductVideo()">确定</a> 
