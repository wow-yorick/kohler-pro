	...
	<div class="container queryConditions ">
		...
		<div class="main">
			<form id="addBannerUnitForm" name="addPageForm">
				...
				<div class="search">
					<div class="row">
						<div class="col-md-2">Id_test</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<input type="text" name="bannerUnitRow"  digits="true" max="5" />
						</div>
					</div>
					<div class="row">
						<div class="col-md-2 tn_l">Column</div>
						<div class="col-md-4">
							<input type="text" name="bannerUnitColumn"  digits="true" max="3" />
						</div>
					</div>
				</div>
				<div class="text">
