    	...
    	<form action = "${base}/category/editCatalog.action" id = "editCatalogForm" name="addPageForm" >
	    	...
	    	<div class="search">
	        	...
	        	<div class="row">
	            	...
	            	<div class="col-md-4"><input type="text" name = "seqNo" maxlength="8" digits="true" value = "${parentCategory.seqNo }" /></div>            	
	            </div>        	
	        </div>              
            ...
            <div class="tab_box">
            	<c:forEach items="${categoryPojos}" var="catePojo" varStatus="status">
		            	...
		            	<div class="box">
		                    ...
		                    <div class="row">
		                        <div class="col-md-2 required">PC Template_${catePojo.language.localeCode }</div>
		                        ...
		                        <div class="col-md-2 tn_c required">Mobile Template_${catePojo.language.localeCode }</div>
		                         <div class="col-md-4 ">
		                    ...
		                    <div class="row">
											...
											<div class="col-md-9 border">
												<input type="text"  id="heroAreasName${catePojo.language.localeId }" value="${catePojo.fieldValue }"
													...
													type="hidden" value="${catePojo.fieldValueId }" name="heroAreaMetadataIds" id="heroAreas${catePojo.language.localeId }" 
													 />
											</div>
											<div class="col-md-1">
