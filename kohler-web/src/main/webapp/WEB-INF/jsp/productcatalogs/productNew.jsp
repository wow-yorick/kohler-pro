		...
		jQuery.validator.addMethod("isProductNameUnique", function(value, element) { 
		    ...
		    if(element.value!=''){
			    $.ajax({
					...
					data:"productName="+element.value+"&lang="+element.getAttribute('isProductNameUnique'),
		            async:false,
		            type:'POST',
		            //dataType:"json",
				...
				<div class="search">
					...
					<div class="row">
						...
						<div class="col-md-4 select_small">
							<select name="collectionMetadataId" required>
								<option></option>
								...
								<div class="box" id="divlan${status.index}">
									<form name ="lan${status.index}" id="lan${status.index}">
										...
										<div class="row">
											...
											<div class="col-md-10 required" style="position: relative;">
												<input type="text" required="true" maxLength="25"  isProductNameUnique="${language.localeId }"  name="productName"/>
											</div>
										</div>
										<div class="row">
									...
									<form name ="lan${status.index}" id="lan${status.index}">
										...
										<div class="row">
											...
											<div class="col-md-10" style="position: relative;">
												<input type="text" maxLength="25"  isProductNameUnique="${language.localeId }"  name="productName" />
											</div>
										</div>
										<div class="row">
