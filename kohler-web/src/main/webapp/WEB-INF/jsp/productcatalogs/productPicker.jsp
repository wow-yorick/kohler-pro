...
$(function(){
	...
	function add(productId,proName,caName,thisObj){
		...
		var html = '<tr>'
        +'<td class="tn_c"><span class="minus" onclick="deleteSkuSelt(this)"></span><input type="hidden" name="productId" class="selectSkuIds" value="'+productId+'"></td>'
        +'<td>'+caName+'</td>'
	...
	function okProduct() {
		...
		var str = "";
		$("#hasSelectList input[name=productId]").each(function(){ 
			str += $(this).val() +",";
		}); 
		if(str != "" && str.length > 0){
...
<div class="container queryConditions product_layer skuPicker">
    ...
    <div class="main">
    	<div class="search">
			...
			<div class="row query">
				<div class="col-md-9">
					<form action="init.action" id="product" method="post">
						<div class="col-md-2 tn_c"><label>Name</label></div>
						<div class="col-md-3"><input type="text" value="${serch.productName}" id="productName" name="productName"></div>
						<div class="col-md-2 tn_c"><label>Category</label></div>
						<div class="col-md-3">
							<select name="productId" id="productId"">
								<option value>-- 请选择 --</option>
								<c:forEach items="${productName}" var="pro">
									<c:if test="${pro.productId == proName}">
        ...
        <table class="big topSmall" border="0" cellspacing="0" cellpadding="0">
        	<tr class="head">
            	<th class="head_l">Product List</th>
            	...
            	<td colspan="2">
                    <table class="small" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <c:forEach items="${category}" var="cat">
	                        <tr>
	                            <td class="tn_c"><span class="plus" onclick="add('${cat.productId}','${cat.productName}','${cat.categoryName}',this);"><input type="hidden" idstr="${cat.productId}"></input></span></td>
