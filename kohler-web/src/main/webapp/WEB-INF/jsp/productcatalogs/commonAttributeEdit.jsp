...
<body>
	<div class="container queryConditions product_layer commonAttribute">
		...
		<form id="editCommonAttrForm">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<input type="text" name = "keyName" isKeyNameUnique = "true" required="required"
													maxlength="25" value = "${categoryComAttrMetadataPojo.keyName }" />
					</div>
				</div>
			</div>
						...
						<c:choose>
							<c:when test="${comAttr.language.isDefault == true }">
								...
								<input type="hidden" name="categoryComAttrIds"
									...
									<div class="row">
										<div class="col-md-2 tn_l required">Name_${comAttr.language.localeCode }</div>
										<div class="col-md-6">
											<input type="text" name = "categoryComAttrNames" required="required" maxlength="25" value = "${comAttr.categoryComAttr.categoryComAttrName }" />
										</div>
									</div>
									...
									<div class="row imgUrl_one">
										...
										<div class="col-md-10">
											<input type="text" name = "imageUrls" maxlength="200" value = "${comAttr.categoryComAttr.imageUrl }" />
										</div>
									</div>
									<div class="row imgUrl_two" style="display:none;">
										<div class="col-md-2 ">Image URL</div>
										<div class="col-md-9 smaller">
											<input type="text" name = "imageIds" id="imageId${language.localeCode }" class="disable" readonly="readonly" value = "${comAttr.categoryComAttr.imageId }" />
										</div>
										<div class="col-md-1">
							...
							<c:otherwise>
								<div class="hide box">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<input type="text" name = "categoryComAttrNames" maxlength="25" value = "${comAttr.categoryComAttr.categoryComAttrName }" />
										</div>
									</div>
									<div class="row higher">
										<div class="col-md-2">Image Icon Source_${comAttr.language.localeCode }</div>
			...
			<div class="txt" id="txt">
				<div class="row">
					...
					<div class="col-md-6 ">
						<input type="text" name = "seqNo" digits="true" maxlength="8" isIntGteZero="true" value = "${categoryComAttrMetadataPojo.seqNo }" />
					</div>
				</div>
				<div class="row">
				...
				<div class="row droplist">
						...
						<div class="col-md-1">
							...
							<div class="checkbox">
								<a href="#" class="ope_icon choo"></a> <input type="checkbox" name = "isFilter" id = "isFilter">
							</div>
						</div>
					</div>
		...
		$(document).ready(
				function() {
					$("select").each(
						...
						var isFilter = '${categoryComAttrMetadataPojo.isFilter }';
						if (isFilter == 'true') {
		...
		jQuery.validator.addMethod("isKeyNameUnique", function(value, element) {
			...
			var categoryMetaId = ${categoryComAttrMetadataPojo.categoryMetadataId };
			
			var categoryComAttrMetadataId = ${categoryComAttrMetadataPojo.categoryComAttrMetadataId };
			...
			var param = {
				...
				categoryComAttrMetadataId : categoryComAttrMetadataId
			};
