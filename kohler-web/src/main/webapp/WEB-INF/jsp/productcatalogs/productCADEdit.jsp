	...
	$(function() {
		...
		$.post("<%=request.getContextPath()%>/content/unlimited/getMasterDateByName.action","masterdataTypeName=TYPE_CAD_TYPE&lang=1",function(data){
			...
			$.each(data.result,function(name,value){
				if(value.masterdataMetadataId=='${productCADMetadataEntity.cadType}'){
										...
										<c:forEach items="${productCADlist}" var="cad">
											<c:if test="${cad.lang eq language.localeId}">
												...
												<div class="row">
													...
													<div class="col-md-9">
														<input type="text" maxlength="25" name="productCADName" required value="${cad.productCADName}" />
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-9 ">
														<input type="text" required name="fileUrl" value="${cad.fileUrl}" maxlength="250" />
													</div>
												</div>
												<div class="row">
												...
												<div class="row large">
													...
													<div class="col-md-9">
														<textarea rows="2" name="description" maxlength="300">${cad.description}</textarea>
													</div>
												</div>
											</c:if>
										</c:forEach>
											...
											<c:if test="${cad.lang eq language.localeId}">
												...
												<div class="row">
													<div class="col-md-3 tn_l">CAD
														Name_${language.localeCode}</div>
													<div class="col-md-9">
														<input type="text" maxlength="25" name="productCADName" value="${cad.productCADName}" />
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-9">
														<input type="text" name="fileUrl" value="${cad.fileUrl}" maxlength="250"/>
													</div>
												</div>
												<div class="row">
