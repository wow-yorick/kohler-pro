...
//});});
	...
	function previewTemplate(){
		var chooses = $("input[name='templateId']:checked").val();
		var choosess = $("input[name='templateId']:checked");
		if(choosess.length > 1){
			alert("请选择一条信息进行查看!");
			return false;
		}
		...
		alertFirstIframe("priveiew","view.action?templateId="+chooses,'840px','600px');
	}
	</script>
					<div class="page">
						<span class=""></span>
