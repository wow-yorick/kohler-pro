...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.ztree.all-3.5.min.js"></script>
    ...
    function updateSpelling(spellingId){
    	alertFirstIframe("update","edit.action?searchSynonymId="+spellingId+"&isEdit=0",'840px','600px');
    }
    function searchSpelling(spellingId){
    	alertFirstIframe("update","edit.action?searchSynonymId="+spellingId+"&isEdit=1",'840px','600px');
    }
    function deleteSeplling(){
    	var jsonData = "";
		var chooses = $("input[name='searchSynonymId']:checked");
		if(chooses.length == 0){
		...
		<div class="content">
			...
			<div class="content_main">
				...
				<div class="condition">
					...
					<form id="searchForm" action="searchSynonymList.action" method="post">	
						<div class="query row">
							<div class="col-md-10">
								...
								<tr>
										<td>
											<div class="checkbox">
												...
												<input type="checkbox" value="${l.searchSynonymId}"
												    name="searchSynonymId">
											</div>
											<a href="#" class="ope_icon edit" onclick="updateSpelling('${l.searchSynonymId}');"></a>
											<a href="#" class="ope_icon detail" onclick="searchSpelling('${l.searchSynonymId}');"></a>
										</td>
