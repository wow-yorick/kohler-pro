    	...
    	<form id="spellingForm">
	    	<div class="search">        	   	
	        	<div class="row">
	            	...
	            	<div class="col-md-4"><input type="text" value="${spelling.keyword}" name="keyword"/></div>
	            	<input type="hidden" value="${spelling.searchKeywordRedirectionId}" name="searchKeywordRedirectionId"/>
	            </div> 
	            <div class="row">
	            	<div class="col-md-2">redirectionUrl</div>
	            	<div class="col-md-4"><input type="text" value="${spelling.redirectionUrl}" name="redirectionUrl"/></div>
	            </div>          	        	
	        </div>                 
	        <div class="btns">
	        	<c:if test="${isEdit != 1 }">
