...
function createSaveFile(){//serialize
	var fileName = $("#fileAssetName").val();
	if(fileName == '' || fileName == null){
		alert("name不能为空！");
		return;
	}
    $.post("createFileSave.action",$("#fileFrom").submit(), function(data) {
...
<div class="container queryConditions product_layer folder">
    ...
    <!--main开始-->
    <div class="main">
    <form id="fileFrom" action="createFileSave.action"  enctype="multipart/form-data" method="post">
        <div class="search">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4 input_small"><input type="text" id="fileAssetName" name="fileAssetName"/></div>
