...
_V_.PlayToggle = _V_.Button.extend({
  ...
  onPlay: function(){
	...
	$(this.el).parents(".bgimg").siblings(".banner_page").hide();
	$(this.el).parents(".bgimg").siblings(".logo").hide();
	timecontrolstop();//停止切换
  },
  ...
  onPause: function(){
	...
	$(this.el).parents(".bgimg").siblings(".banner_page").show();
	$(this.el).parents(".bgimg").siblings(".logo").show();
	 timecontrolstart();//继续切换
  }
